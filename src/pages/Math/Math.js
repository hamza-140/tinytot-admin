...
function Math() {
  return (
    <div
      ...
      <h1 className="text-4xl font-bold mb-12">Math Modules</h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-8 px-4">
        ...
        <Link
          ...
          <h2 className="text-2xl font-semibold text-black mb-2">Lessons</h2>
          <p className="text-gray-600">Explore lessons related to numbers.</p>
        </Link>
        {/* Phonics Card */}
        {/* <Link
          to="/english/phonics"
          ...
          <h2 className="text-2xl font-semibold text-black mb-2">Phonics</h2>
        ...
        {/* <Link
          ...
          <h2 className="text-2xl font-semibold text-black mb-2">Shapes</h2>
          <p className="text-gray-600">Discover shapes vocabulary.</p>
        </Link> */}
        {/* Animals Card */}
        {/* <Link
          to="/english/animals"
          ...
          <h2 className="text-2xl font-semibold text-black mb-2">Animals</h2>
          <p className="text-gray-600">Explore animal names and sounds.</p>
        </Link> */}
      </div>
    </div>
  );
